...
const ClassData = require('./class_data'),
    ...
    AnnotationData = require('./annotation_data'),
 ...
 * @param classId the class' id.
 * @param annotationId its id.
 * @param data the annotation data.
 */
ParsedData.prototype.addAnnotation = function(classId, annotationId, data) {
  var ann = new AnnotationData(data);
  //this.annotations[annotationId] = ann;
  this.classes[classId].addAnnotation(ann);
};
